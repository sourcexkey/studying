package com.xkey.webcam.streaming.handler;
...
import com.xkey.webcam.streaming.handler.frame.FrameEncoder;
...
public class H264StreamEncoder extends OneToOneEncoder {
    ...
    protected final IStreamCoder iStreamCoder = IStreamCoder.make(Direction.ENCODING, ICodec.ID.CODEC_ID_MPEG4);
